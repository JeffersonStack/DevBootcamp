(function () {
    ...
    */
    const people1 = { name: 'Jefferson', lastName: 'Teles' }
    const people2 = { name: 'Anderson', lastName: 'Teles' }
    ...
    */
    const userEntry = prompt('Entre com alguns números que serão somados:');
    ...
    */
    ...
    const numbers = justNumbers(userEntry)
    console.log(numbers)
