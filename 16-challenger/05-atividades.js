(function() {
  ...
  */
  ...
  let nome = "Jefferson";
  for (let i = 0, len = nome.length; i < len; i++) {
  ...
  */
  console.log("\nMeus amigos:");
  let nomes = ["Jefferson", "Anderson", "Maria", "Kellen", "Sofia"];
  console.log(nomes);

  let reduce = nomes
    .reduce(function(acum, atual, index, array) {
      let separador = nomes.length - 1 === index ? " e " : " , ";
      return acum + separador + atual;
    })
