(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, "Jefferson Teles"));
    ...
    */
    ...
    console.log(`O mês de desembro é representado pelo número ${getMonthNumber('dezembro')}.`)
    ...
    */
    ...
    function replaceDate(regex, day, mounth, year) {
        return day + '/' + getMonthNumber(mounth) + '/' + year
    }
